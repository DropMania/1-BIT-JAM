...
export default class TestDog extends Enemy {
	constructor(scene, x, y, props) {
        ...
        this.graphics = this.scene.add.graphics({ lineStyle: { width: 1, color: 0x00ff00}, fillStyle: { color: 0xffffff, alpha: 0.3 } });
	...
	update() {
        ...
        for(let CircleIntersection of CircleIntersections){
            if (!CircleIntersection.object && CircleIntersection.object === undefined){return}
            // debugger
